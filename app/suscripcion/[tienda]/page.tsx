...
// El slug viaja en el PATH (no en query) para que el ?preapproval_id que agrega
// MP no lo rompa. No requiere sesión (el "Volver al sitio" siempre funciona).
export default async function SuscripcionOkPage({ params }: { params: Promise<{ tienda: string }> }) {
  const slug = (await params).tienda || "";
