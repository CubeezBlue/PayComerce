...
import { hashPassword, sessionToken, SESSION_COOKIE } from "@/lib/auth";
...
export async function POST(req: NextRequest) {
  ...
  const store = createStore(slug, name, new Date().toISOString(), password ? hashPassword(password) : undefined, plan);
